...
class ChatService {
  ...
  async streamChat(params, onDelta, onComplete, onError) {
    const { topic_id: providedTopicId, user_id, expert_id, content, model_id, task_id, task_path, session } = params;
   ...
   */
  async chat(params) {
    const { topic_id, user_id, expert_id, content, model_id, task_id, task_path, session } = params;
